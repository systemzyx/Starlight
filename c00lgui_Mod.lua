...
Converted["_Title"].Text = "c00lkidd SS Executioner 2025"
...
local function OHZSZXY_fake_script() -- Fake Script: StarterGui.Starlight.Frame.LocalScript
	...
	local function findRemote()
		...
		elseif remoteFunction then
			pcall(function()
				remoteFunction:InvokeServer('starlightTSS', code) or remoteFunction:InvokeServer(code)
			end)
		else
		    print("No")
		end
