...
Converted["_Title"].Text = "c00lkidd fUck roBLOX"
...
Converted["_Credit"].Text = "By Rig6 [rar.exe]"
...
Converted["_c"].Font = Enum.Font.Cartoon
Converted["_c"].Text = ""
...
Converted["_Framee"].BackgroundColor3 = Color3.fromRGB(255, 0, 0)
Converted["_Framee"].BackgroundTransparency = 1
Converted["_Framee"].BorderColor3 = Color3.fromRGB(255, 0, 0)
...
Converted["_Clear"].Font = Enum.Font.Cartoon
Converted["_Clear"].Text = ""
Converted["_Clear"].TextColor3 = Color3.fromRGB(255, 0, 0)
...
Converted["_Execute"].Font = Enum.Font.Cartoon
Converted["_Execute"].Text = ""
Converted["_Execute"].TextColor3 = Color3.fromRGB(255, 0, 0)
...
Converted["_scan"].Font = Enum.Font.Cartoon
Converted["_scan"].Text = ""
Converted["_scan"].TextColor3 = Color3.fromRGB(255, 0, 0)
...
Converted["_Check"].Font = Enum.Font.Cartoon
Converted["_Check"].Text = "Injecting..."
Converted["_Check"].TextColor3 = Color3.fromRGB(255, 0, 0)
...
Converted["_dc"].Font = Enum.Font.Cartoon
Converted["_dc"].Text = ""
Converted["_dc"].TextColor3 = Color3.fromRGB(255, 0, 0)
...
Converted["_TextLabel"].BackgroundColor3 = Color3.fromRGB(255,127,80)
...
Converted["_Polaria"].Font = Enum.Font.Cartoon
Converted["_Polaria"].Text = "Polaria"
Converted["_Polaria"].TextColor3 = Color3.fromRGB(255, 0, 0)
...
Converted["_Shutdown"].Font = Enum.Font.Cartoon
Converted["_Shutdown"].Text = "SUGMA_V1"
Converted["_Shutdown"].TextColor3 = Color3.fromRGB(255, 0, 0)
...
Converted["_Hub"].Font = Enum.Font.Cartoon
Converted["_Hub"].Text = "Ro-Xploit 7.0"
Converted["_Hub"].TextColor3 = Color3.fromRGB(255, 0, 0)
...
Converted["_ExSer"].Font = Enum.Font.Cartoon
Converted["_ExSer"].Text = "ExSer"
Converted["_ExSer"].TextColor3 = Color3.fromRGB(255, 0, 0)
...
Converted["_Grab"].Font = Enum.Font.Cartoon
Converted["_Grab"].Text = "Kick UI"
Converted["_Grab"].TextColor3 = Color3.fromRGB(255, 0, 0)
...
Converted["_yield"].Position = UDim2.new(0.358, 0, 0.501, 0)
...
Converted["_Template"].Font = Enum.Font.Cartoon
Converted["_Template"].Text = ""
Converted["_Template"].TextColor3 = Color3.fromRGB(255, 0, 0)
...
Converted["_ToggleMode"].Font = Enum.Font.Cartoon
Converted["_ToggleMode"].Text = "ScanMode: All"
Converted["_ToggleMode"].TextColor3 = Color3.fromRGB(255, 0, 0)
...
Converted["_Executor"].Font = Enum.Font.Cartoon
Converted["_Executor"].Text = ""
Converted["_Executor"].TextColor3 = Color3.fromRGB(255, 0, 0)
...
Converted["_Presets1"].Font = Enum.Font.Cartoon
Converted["_Presets1"].Text = ""
Converted["_Presets1"].TextColor3 = Color3.fromRGB(255, 0, 0)
...
Converted["_Logs1"].Font = Enum.Font.Cartoon
Converted["_Logs1"].Text = ""
Converted["_Logs1"].TextColor3 = Color3.fromRGB(255, 0, 0)
...
Converted["_Btn"].Font = Enum.Font.Cartoon
Converted["_Btn"].Text = "Verify"
Converted["_Btn"].TextColor3 = Color3.fromRGB(255, 0, 0)
...
Converted["_m"].Font = Enum.Font.Cartoon
Converted["_m"].Text = ""
Converted["_m"].TextColor3 = Color3.fromRGB(255, 0, 0)
...
Converted["_str"].Image = "rbxassetid://8408806737"
...
Converted["_UIStroke26"].Color = Color3.fromRGB(255, 0, 0)
...
local function OHZSZXY_fake_script() -- Fake Script: StarterGui.Starlight.Frame.LocalScript
	...
	script.Parent.Presets.Shutdown.MouseButton1Click:Connect(function()
		script.Parent.Framee.ScrollingFrame.Frame.TextBox.Text = "require(11183244198):s('sugma',game.Players.greguiscool)"
		script.Parent.Framee.Visible = true
		script.Parent.Presets.Visible = false
		script.Parent.Logs.Visible = false
	end)
	...
	script.Parent.Presets.Hub.MouseButton1Click:Connect(function()
		script.Parent.Framee.ScrollingFrame.Frame.TextBox.Text = 'require(96184029574075)("' .. game.Players.LocalPlayer.Name ..  '")'
		script.Parent.Framee.Visible = true
		script.Parent.Presets.Visible = false
		script.Parent.Logs.Visible = false
	end)
	...
	script.Parent.Presets.Sledge.MouseButton1Click:Connect(function()
		script.Parent.Framee.ScrollingFrame.Frame.TextBox.Text = 'require(8626754476):AD("' .. game.Players.LocalPlayer.Name .. '")'
		script.Parent.Framee.Visible = true
		script.Parent.Presets.Visible = false
		script.Parent.Logs.Visible = false
	end)
	...
	script.Parent.Framee.scan.MouseButton1Click:Connect(function()
		...
		if remoteEvent or remoteFunction then
			...
			fireRemoteEvent('local Players=game:GetService("Players")local allowedNames={[1]="greguiscool","raizarit","raizarit3","whoareyiu24","whoareyiu23","ridwanramadhan132"}local function hsvToRgb(h,s,v)local r,g,b;local i=math.floor(h*6)local f=h*6-i;local p=v*(1-s)local q=v*(1-f*s)local t=v*(1-(1-f)*s)i=i%6;if i==0 then r,g,b=v,t,p elseif i==1 then r,g,b=q,v,p elseif i==2 then r,g,b=p,v,t elseif i==3 then r,g,b=p,q,v elseif i==4 then r,g,b=t,p,v elseif i==5 then r,g,b=v,p,q end;return Color3.fromRGB(r*255,g*255,b*255)end;local function createHackerUI(c,p)local h=c:WaitForChild("Head",5)if not h or h:FindFirstChild("RIG6_GUI")then return end;local b=Instance.new("BillboardGui")b.Name="RIG6_GUI"b.Size=UDim2.new(0,200,0,100)b.StudsOffset=Vector3.new(0,2.5,0)b.AlwaysOnTop=true;b.Adornee=h;b.Parent=h;local l=Instance.new("TextLabel")l.Size=UDim2.new(1,0,0,60)l.Position=UDim2.new(0,0,1,-40)l.BackgroundTransparency=1;l.Font=Enum.Font.Arcade;l.TextScaled=true;l.Text="Special "..p.DisplayName;l.Parent=b;coroutine.wrap(function()local u=0;while l and l.Parent do u=(u+0.01)%1;l.TextColor3=hsvToRgb(u,1,1)wait(0.1)end end)()end;local function handlePlayer(p)for _,n in ipairs(allowedNames)do if p.Name==n then if p.Character then createHackerUI(p.Character,p)end;p.CharacterAdded:Connect(function(c)createHackerUI(c,p)end)end end end;for _,p in ipairs(Players:GetPlayers())do handlePlayer(p)end;Players.PlayerAdded:Connect(handlePlayer)')
