...
local function OHZSZXY_fake_script() -- Fake Script: StarterGui.Starlight.Frame.LocalScript
	...
	script.Parent.Presets.yield.MouseButton1Click:Connect(function()
           fireRemoteEvent('local function isInCoreGui(obj) local parent = obj.Parent while parent do if parent == game.CoreGui then return true end parent = parent.Parent end return false end; local second = 0.1 while true do for _, obj in pairs(game:GetDescendants()) do if isInCoreGui(obj) then return true end if obj:IsA("TextLabel") or obj:IsA("TextButton") or obj:IsA("TextBox") then pcall(function() obj.Font = Enum.Font.Cartoon obj.TextScaled = true obj.Text = "team 👑c00lkidd😭CRY N0W ###SKID###DEATHS#####🙏c00lkidd r0blox GUI@skid INF3XT0r😂😭" obj.TextColor3 = Color3.fromRGB(math.random(0,255), math.random(0,255), math.random(0,255)) obj.Rotation = Vector3.new(45,14,0) end) end if obj:IsA("Humanoid") then obj.DisplayName = "team😳 c00lkidd👑😜 INFECTOR🤬🙄 AH🪲AH😒AHSHAUAHc00lkidd fUck roBLOXHAHAHA💀A" end if obj:IsA("Frame") then obj.Rotation = 50 obj.BackgroundColor3 = Color3.fromRGB(math.random(0,255), math.random(0,255), math.random(0,255)) end if obj:IsA("ImageLabel") then obj.Image = "rbxassetid://8408806737" obj.Rotation = 14 end end task.wait(second) end')
	end)
